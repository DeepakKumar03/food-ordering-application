...
public class OrderServiceImp implements OrderService {
  ...
  /**
   * Depedency of all entity dao used in order business service have been injected using @Autowired
   * annotation
   */
  ...
  /**
   * @param couponName
   * @return coupon entity extracted from database using coupon name supplied through request object
   *     via controller
   * @throws CouponNotFoundException
   */
